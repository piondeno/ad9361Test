...
HD_PWD='D:/projects/adi_hdl/projects/fmcomms2/kcu105/fmcomms2_kcu105.runs/system_axi_ethernet_dma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_ethernet_dma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_ethernet_dma_0.tcl
