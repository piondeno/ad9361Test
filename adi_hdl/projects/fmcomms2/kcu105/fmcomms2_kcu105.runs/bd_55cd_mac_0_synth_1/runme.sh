...
HD_PWD='F:/projects/ad9361Test/adi_hdl/projects/fmcomms2/kcu105/fmcomms2_kcu105.runs/bd_55cd_mac_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_55cd_mac_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_55cd_mac_0.tcl
