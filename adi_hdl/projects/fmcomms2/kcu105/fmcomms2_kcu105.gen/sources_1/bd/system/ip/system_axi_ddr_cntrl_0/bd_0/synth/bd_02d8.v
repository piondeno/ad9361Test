...
//--------------------------------------------------------------------------------
//Command: generate_target bd_02d8.bd
//Design : bd_02d8
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_02d8,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_02d8,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "system_axi_ddr_cntrl_0_microblaze_mcs.hwdef" *) 
module bd_02d8
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    TRACE_reg_write,
    TRACE_valid_instr);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN bd_02d8_Clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_02d8 lmb_bram_I bd_02d8 second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_02d8_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_02d8_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_02d8_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_02d8_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_02d8 dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_02d8_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_02d8_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_02d8_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_02d8_second_lmb_bram_I_0 second_lmb_bram_I
