...
################################################################
# This is a generated script based on design: bd_518a
#
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.READ_WRITE_MODE {READ_WRITE} \
   CONFIG.SSC000_ROUTE {0b0000000} \
   CONFIG.SSC001_ROUTE {0b0000000} \
   CONFIG.SSC002_ROUTE {0b0000001} \
   CONFIG.SSC003_ROUTE {0b0000010} \
   CONFIG.SSC004_ROUTE {0b0000100} \
   CONFIG.SSC005_ROUTE {0b0001000} \
   CONFIG.SSC006_ROUTE {0b0010000} \
   CONFIG.SSC007_ROUTE {0b0100000} \
   CONFIG.SSC008_ROUTE {0b1000000} \
   CONFIG.SSC009_ROUTE {0b0000000} \
   CONFIG.SSC010_ROUTE {0b0000000} \
   CONFIG.SSC011_ROUTE {0b0000000} \
   CONFIG.SSC012_ROUTE {0b0000000} \
   CONFIG.SSC013_ROUTE {0b0000000} \
   CONFIG.SSC014_ROUTE {0b0000000} \
   CONFIG.SSC015_ROUTE {0b0000000} \
