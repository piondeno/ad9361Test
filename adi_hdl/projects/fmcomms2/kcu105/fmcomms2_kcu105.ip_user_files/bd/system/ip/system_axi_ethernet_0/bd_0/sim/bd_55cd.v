...
(* CORE_GENERATION_INFO = "bd_55cd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_55cd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "system_axi_ethernet_0.hwdef" *) 
module bd_55cd
   (axi_rxd_arstn,
    axi_rxs_arstn,
    axi_txc_arstn,
  ...
  bd_55cd_xlconstant_config_val_0 xlconstant_config_val
       (.dout(xlconstant_config_val_dout));
  bd_55cd_xlconstant_config_vec_0 xlconstant_config_vec
