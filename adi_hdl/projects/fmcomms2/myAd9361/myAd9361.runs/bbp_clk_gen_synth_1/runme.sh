...
HD_PWD='D:/projects/adi_hdl/projects/fmcomms2/myAd9361/myAd9361.runs/bbp_clk_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bbp_clk_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bbp_clk_gen.tcl
