...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ bbp_clk_gen_sim_netlist.vhdl
-- Design      : bbp_clk_gen
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bbp_clk_gen_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bbp_clk_gen_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bbp_clk_gen_clk_wiz is
  signal clk_DDR_bbp_clk_gen : STD_LOGIC;
  signal clk_DDR_double_bbp_clk_gen : STD_LOGIC;
  signal clk_DDRn_bbp_clk_gen : STD_LOGIC;
  signal clk_from_ad9361_bbp_clk_gen : STD_LOGIC;
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bbp_clk_gen_clk_wiz
     port map (
      clk_DDR => clk_DDR,
      clk_DDR_double => clk_DDR_double,
      clk_DDRn => clk_DDRn,
      clk_from_ad9361 => clk_from_ad9361,
      locked => locked,
      reset => reset
    );
end STRUCTURE;
