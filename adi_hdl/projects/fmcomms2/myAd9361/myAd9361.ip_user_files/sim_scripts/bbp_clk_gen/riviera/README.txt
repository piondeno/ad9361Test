...
#
# Generated by export_simulation on Sat Dec 04 17:08:49 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './bbp_clk_gen.sh' script.

./bbp_clk_gen.sh -reset_run
...
./bbp_clk_gen.sh -noclean_files

For more information on the script, please type './bbp_clk_gen.sh -help'.
