...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PATH_TO_FILE" -parent ${Page_0}
...
proc update_PARAM_VALUE.PATH_TO_FILE { PARAM_VALUE.PATH_TO_FILE } {
	# Procedure called to update PATH_TO_FILE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PATH_TO_FILE { PARAM_VALUE.PATH_TO_FILE } {
	# Procedure called to validate PATH_TO_FILE
	return true
}
...
proc update_MODELPARAM_VALUE.PATH_TO_FILE { MODELPARAM_VALUE.PATH_TO_FILE PARAM_VALUE.PATH_TO_FILE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PATH_TO_FILE}] ${MODELPARAM_VALUE.PATH_TO_FILE}
}
