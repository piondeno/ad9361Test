...
class slaveAxiLiteIF extends Bundle {
  val in = new slaveAxiLiteIF_in
  val out = new  slaveAxiLiteIF_out
}
...
class dmaAdcIF extends Bundle {
  val in = new dmaAdcIF_in
  val out = new dmaAdcIF_out
}
...
class dmaDacIF extends Bundle {
  val in = new dmaDacIF_in
  val out = new dmaDacIF_out
}
